...
# Separate charanters from authors
...
'''
Change some parameters and preprocessings to improve fastText.
'''
...
'''
Change the number of hidden units and optimizer algorithm to obtain a better result.
'''
...
num_hiddens = [10, 20, 30]
optimizers = ['adam', 'adadelta']
param_grid = dict(embedding_dims=num_hiddens, optimizer=optimizers)
